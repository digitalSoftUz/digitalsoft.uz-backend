...
class FormContentAdmin(admin.ModelAdmin):
    list_display = ['title', 'subtitle1', 'text1', 'subtitle2',
                    'text2', 'hide_second_part', 'type', 'is_active']


@admin.register(PartnerFeedback)
class PartnerFeedbackAdmin(admin.ModelAdmin):
    list_display = ['partner_name', 'partner_bio',
                    'partner_image', 'feedback', 'order', 'is_active']
...
class ContactInfoAdmin(admin.ModelAdmin):
    list_display = ['address', 'facebook', 'instagram', 'telegram', 'tweeter',
